...
def launch_minitia(network, mnemonic):
    config_data = {
        "l1_config": {
            "rpc_url": "https://rpc-initia.01node.com:443",
...
def create_minitia_service():
  ...
  Environment="DAEMON_HOME=${{HOME}}/.minitiad"
  Environment="DAEMON_RESTART_AFTER_UPGRADE=true"
  Environment="DAEMON_ALLOW_DOWNLOAD_BINARIES=false"
  Environment="UNSAFE_SKIP_BACKUP=true"
  User={username}
  ExecStart=${{HOME}}/go/bin/minitiad start
  Restart=always
  RestartSec=3
  LimitNOFILE=4096
  ...
  """
    ...
    # Write the service file with elevated privileges
    try:
    ...
    try:
        ...
        print("bandd service started successfully.")
    except subprocess.CalledProcessError as e:
...
def get_mnemonic():
    ...
    print("Please enter the mnemonic of the account:")
    mnemonic = input()
    return mnemonic
